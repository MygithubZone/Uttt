...
import com.raythinks.utime.mvp.presenter.TrafficStatsPresenterImpl;
...
public class TrafficStatsActivity extends BaseActivity<TrafficStatsPresenterImpl> implements TrafficStatsContract.View, ViewPager.OnPageChangeListener, View.OnClickListener {
    ...
    @Override
    public TrafficStatsPresenterImpl getmPresenter() {
        return new TrafficStatsPresenterImpl(this, this);
    }
